<template>
  <div class="home w-full h-full">
    ...
    <section class="container mx-auto flex">
      <div class="bg-primary text-white font-bold text-2xl px-8">CS Notice</div>
    ...
    <section class="slider-section container mx-auto mt-2">
      <carousel :items-to-show="2.5" class="w-full text-left">
